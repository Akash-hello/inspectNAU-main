...
namespace TextSpeech
{
    public class TextToSpeech : MonoBehaviour
    {
        ...
        public static TextToSpeech instance
        {
            get
            {
                if (_instance == null) //THIS ERROR POPS UP SOMETIMES; StackOverflowException: The requested operation caused a stack overflow.
                                        //UnityEngine.Object.op_Equality(UnityEngine.Object x, UnityEngine.Object y)(at < 10871f9e312b442cb78b9b97db88fdcb >:0)
                {
                    Init();
                }
                return _instance;
